			...
			<table bgColor="#c0c0c0">
				...
				<tr>
					...
					<td><input type="radio" name="xb" <%if (stu.getXb() == 1) {%>
						...
						name="xb" <%if (stu.getXb() == 0) {%> checked <%}%>
						value="0">女</td>
				</tr>
				<tr>
					<td>出生日期：</td>
					<td><input type="text" name="csrq" size=20
						value="<%
							if(stu.getCsrq() == null){
								out.print("");
							}else{
				...
				<tr>
					...
					<%--隐藏一个控件，用于保存用户id,提交时会把id和其他控件一起封装到request方法里--%>
